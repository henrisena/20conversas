...
/* Produção docente: injeta automaticamente os livros nas páginas individuais sem substituir o conteúdo dos perfis. */
(function(){
  ...
  // Se a página já tiver a nova seção, não duplica.
  if(document.getElementById('profileBookGrid')) return;
